...
namespace FixtureExplorerTest
{
    ...
    public class AttributeDocumenterTest
    {
        ...
        public void AttributeDocumenterDeprecationTest()
        {
            ...
            Assert.AreEqual("[Deprecated: use TestMethod1 instead]", documenter.MethodBaseDeprecationMessage(doctest.GetMethod("TestMethod2")));
            Assert.AreEqual("[Deprecated]", documenter.MethodBaseDeprecationMessage(doctest.GetMethod("NullDocMethod")));
            ...
            Assert.AreEqual("[Deprecated: Overriding obsolete message]",
        ...
        public void AttributeDocumenterDocumentationTest()
        {
            ...
            Assert.AreEqual("TestMethod1 Documentation", documenter.MethodBaseDocumentation(doctest.GetMethod("TestMethod1")));
            Assert.AreEqual("Property1 Documentation", documenter.MethodBaseDocumentation(doctest.GetMethod("get_Property1")));
            Assert.IsTrue(string.IsNullOrEmpty(documenter.MethodBaseDocumentation(doctest.GetMethod("set_NoDocProperty"))));
